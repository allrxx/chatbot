      ...
      >
        ...
        <div
          ...
          style={{
            ...
            overflowY: 'auto', // Apply scrolling here
            padding: '24px 32px', // Apply padding here
            display: 'flex',
            flexDirection: 'column',
            gap: '24px', // Apply gap here
            // Add padding to the right to account for scrollbar width (optional, adjust value)
            paddingRight: 'calc(32px - 8px)', // Example: Subtract scrollbar width
          }}
        >
          {/* Dialog Title */}
          <h2 style={{
